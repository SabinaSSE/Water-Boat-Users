            ...
            <div class="offer-container">
                <div class="offer">
                    ...
                    <div class="offer-details">
                        ...
                        <a href="blog_page3.html" class="offer-button">Details</a>
                    </div>
                </div>
                <div class="offer">
                    ...
                    <div class="offer-details">
                        ...
                        <a href="blog_page1.html" class="offer-button">Details</a>
                    </div>
                </div>
                <div class="offer">
                    <img src="images/cruise3.jpg" alt="Cruise Offer 2">
                    <div class="offer-details">
                        <h3 class="offer-title">Caribbean Cruise Adventure</h3>
                        <p class="offer-description">Embark on an unforgettable adventure to the Caribbean islands. Limited time offer: 20% off for early bookings!</p>
                        <a href="blog_page2.html" class="offer-button">Details</a>
                    </div>
                </div>
                <div class="offer">
                    <img src="images/cruise3.jpg" alt="Cruise Offer 2">
